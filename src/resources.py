...
class PackageProgressDialog(QDialog,ui_packaging):
    ...
    def __init__(self, n_files, output_path, log_queue,theme_colors=None):
        """Class constructor
        ...
        output_path: str
            Path where the zip file with the application will be created
        log_queue: queue
    ...
    def check_packaging_progress(self):
        try:
            self.output_path = "%s.zip" % self.output_path
